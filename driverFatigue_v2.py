...
#         print("⚠️ Frame capture failed, skipping this frame...")
#         continue  # skip to next iteration
#
#     frame = imutils.resize(frame, width=640)
#
#     # Ensure image is 8-bit before converting
    ...
    for rect in rects:
        ...
        if mouEAR > MOU_AR_THRESH:
            cv2.putText(frame, "Yawning", (10, 70),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            yawnStatus = True
            output_text = f"Yawn Count: {yawns + 1}"
        ...
        cv2.putText(frame, f"MAR: {mouEAR:.2f}", (480, 60),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
